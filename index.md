...
venue: "UNSW Australia"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Colombo and Goldstein Buildings, UNSW, Sydney"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "-33.916223,151.2291353"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "10-12 Sep 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2019-09-12        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Brian Ballsun-Stanton, Conrad Gillard, Bill McLean, Nathaniel Butterworth, Timothy Amos, Richard Miller"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Leyton Han, Fiona Jones, Svetlana Tkachenko, Matthias Liffers, Nishen Naidoo, Wilfred Gee, Mark Minchenko, John Zaitseff"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["resbazsydney@googlegroups.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:   http://pad.carpentries.org/2019-09-10-RezbazSyd-IntroPython          # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
